...
dbLoadRecords("$(TOP)/db/iocAdminSoft.db", "IOC=XF:23ID1-CT{IOC:IOC1}")
dbLoadRecords("$(TOP)/db/iocAdminSoftAdd.db", "IOC=XF:23ID1-CT{IOC:IOC1}")
...
dbl > /cf-update/xf23id1-ioc1.sysmon.dbl
